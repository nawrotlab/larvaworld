...
For background on DEB theory, see Kooijman (2010), *Dynamic Energy Budget theory for metabolic organisation*; for implementation details, see {doc}`../agents_environments/larva_agent_architecture`.
