...
def init_pars():
    ...
    d = {
        ...
        'freq_range': {'t': Tuple[float], 'v': (0.5, 2.5), 'disp': 'range', 'vfunc': param.Range,
                       'combo': 'frequency', 'k': 'f_C_r', 'lim': (0.0, 5.0), 'u': ureg.Hz,
                       'h': 'The frequency range of the repetitive crawling behavior.'},
        'initial_freq': {'v': 1.418, 'lim': (0.0, 5.0), 'aux_vs': ['sample'], 'disp': 'initial', 'k': 'f_C0',
                         'vfunc': param.Number,
        ...
        'freq_std': {'v': 0.0, 'lim': (0.0, 1.0), 'k': 'f_C_std', 'disp': 'std', 'combo': 'frequency', 'u': ureg.Hz,
                     'vfunc': param.Number,
        ...
        'initial_amp': {'lim': (0.0, 2.0), 'disp': 'initial', 'combo': 'amplitude', 'k': 'A_C0', 'vfunc': param.Number,
