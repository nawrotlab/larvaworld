        ...
        def init_mods():
            d = dNl.NestDict({
                ...
                'olfactor': {
                    ...
                    'decay_coef': {'v': 0.0, 'lim': (0.0, 2.0), 'label': 'decay coefficient', 'symbol': sub('c', 'O'),
                                   'u_name': None, 'vfunc': param.Number,
                ...
                'toucher': {
                    ...
                    'input_noise': {'v': 0.0, 'lim': (0.0, 1.0), 'h': 'The intrinsic noise of the sensory input.',
                                    'vfunc': param.Magnitude},
                    'decay_coef': {'v': 0.1, 'lim': (0.0, 2.0), 'vfunc': param.Number,
                ...
                'feeder': {
                    ...
                    'feed_radius': {'v': 0.1, 'lim': (0.1, 10.0), 'vfunc': param.Number,
            ...
            d['sinusoidal_turner'] = {
                'initial_amp': {'v': 19.27, 'min': 0.1, 'max': 100.0, 'lim': (0.1, 100.0), 'disp': 'initial',
                                'combo': 'amplitude',
                                'label': 'output amplitude', 'symbol': '$A_{T}^{0}$', 'u_name': None, 'k': 'A_T0',
                                'vfunc': param.Number,
                                'h': 'The initial activity amplitude of the TURNER module.'},
                'amp_range': {'t': Tuple[float], 'min': 0.1, 'max': 100.0, 'lim': (0.1, 100.0), 'v': (10.0, 30.0),
