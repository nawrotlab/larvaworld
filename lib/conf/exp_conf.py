...
from lib.conf.dtypes import enrichment_dict, null_dict, oG, oD
...
def RvsS_groups(N=1, age=72.0, q=1.0, sub='standard', h_starved=0.0,
    ...
    return {
        **lg('Rover', m='rover', c='blue', N=N, **group_kws),
...
grouped_exp_dict = {
    ...
    'chemotaxis': {
        ...
        'food_at_bottom': exp('food_at_bottom', sim={'duration': 20.0, 'timestep': 0.09}, en=True,
                              l=lgs(models=['Orco_forager', 'forager'],
                                    ids=['Orco', 'control'], N=20, sh='oval', p=(0.0, 0.04), s=(0.04, 0.01)))
    },
    ...
    'games': {
        ...
        'keep_the_flag': game_exp('keep_the_flag', l=game_groups(mode='king')),
        'capture_the_flag': game_exp('capture_the_flag', l=game_groups(mode='flag')),
