    ...
    def generate_database(self, mode):
        if mode == 'step':
            ...
            step_parameter_partial = {
                ...
                "turner_activation": lambda a: a.turner.activation,
                "turner_activity": lambda a: a.ang_activity,

                "crawler_activity": lambda a: a.lin_activity,
                "crawler_phi": lambda a: a.crawler.phi,
                "peristalsis_cycle": lambda a: a.crawler.complete_iteration,

                "feeder_cycle": lambda a: a.feeder.complete_iteration,
                ...
                "pause_start": lambda a: a.intermitter.pause_start,
                "pause_stop": lambda a: a.intermitter.pause_stop,
                "pause_dur": lambda a: a.intermitter.pause_dur,
                "pause_id": lambda a: a.intermitter.pause_id,

                "stridechain_start": lambda a: a.intermitter.stridechain_start,
                "stridechain_stop": lambda a: a.intermitter.stridechain_stop,
                "stridechain_dur": lambda a: a.intermitter.stridechain_dur,
                "stridechain_id": lambda a: a.intermitter.stridechain_id,
                "stridechain_length": lambda a: a.intermitter.stridechain_length,
            ...
            endpoint_parameter_database = {
                ...
                "num_strides": lambda a: a.crawler.iteration_counter,
                "stride_dur_ratio": lambda a: a.crawler.total_t / a.sim_time,
                "vel_freq": lambda a: a.crawler.freq,
                ...
                "stride_dst_mean":
                    lambda a: (a.cum_dst / a.crawler.iteration_counter) * 1000 / a.model.scaling_factor,

                "stride_scaled_dst_mean":
                    lambda a: (a.cum_dst / a.get_sim_length()) / a.crawler.iteration_counter,

                "stridechain_dur_ratio": lambda a: a.intermitter.cum_stridechain_dur / a.sim_time,
                "pause_dur_ratio": lambda a: a.intermitter.cum_pause_dur / a.sim_time,

                "mass": lambda a: a.get_real_mass() * 1000,
                "num_pauses": lambda a: a.intermitter.pause_counter,
                "cum_pause_dur": lambda a: a.intermitter.cum_pause_dur,
                "num_stridechains": lambda a: a.intermitter.stridechain_counter,
                "cum_stridechain_dur": lambda a: a.intermitter.cum_stridechain_dur,

                "num_feeds": lambda a: a.feeder.iteration_counter,
                "feed_dur_ratio": lambda a: a.feeder.total_t / a.sim_time,
                "feed_success_rate": lambda a: a.feed_success_counter / a.feeder.iteration_counter,
                "amount_eaten": lambda a: a.amount_eaten,
...
step_db = {
    ...
    'fee_N': lambda a: a.feeder.iteration_counter,
    'pau_N': lambda a: a.intermitter.pause_counter,
    'str_N': lambda a: a.crawler.iteration_counter,
    'fee_tr': lambda a: a.feeder.total_t / a.sim_time,
    'pau_tr': lambda a: a.intermitter.cum_pause_dur / a.sim_time,
    'str_tr': lambda a: a.crawler.total_t / a.sim_time,
    'chn0': lambda a: a.intermitter.stridechain_start,
    'chn1': lambda a: a.intermitter.stridechain_stop,
    'pau0': lambda a: a.intermitter.pause_start,
    'pau1': lambda a: a.intermitter.pause_stop,
    # 'fee_t': lambda a: a.feeder.total_t / a.sim_time,
    'pau_t': lambda a: a.intermitter.pause_dur,
    'pau_id': lambda a: a.intermitter.pause_id,
    # 'str_t': lambda a: a.crawler.total_t / a.sim_time,
    'chn_t': lambda a: a.intermitter.stridechain_dur,
    'chn_id': lambda a: a.intermitter.stridechain_id,
    'chn_l': lambda a: a.intermitter.stridechain_length,
