...
def buildInitDict(CTs):
    # self.ConfSelector(default=default, single_choice=single_choice)
...
class ParInitDict(base.BaseConfDict):
    ...
    def i2m(self, k):
        return data_aux.init2mdict({k:self.dict[k]})
