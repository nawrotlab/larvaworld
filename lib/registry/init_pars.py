...
def buildInitDict():
    ...
    def pPath(conftype=None, h=None, k=None, **kwargs):
        if h is None:
            h = f'The relative p ath to store the {conftype} datasets.'
    ...
    def init_distpars():
        ...
        # d['larva_model'] = confID_entry('Model', default='RE_NEU_PHI_DEF')

        d['Larva_DISTRO'] = {
            'model': confID_entry('Model', default='RE_NEU_PHI_DEF'),
            **d['larva_distro'],
        }
...
class ParInitDict:
    ...
    def metric_def(self, ang={}, sp={}, **kwargs):
        def ang_def(b='from_angles', fv=(1, 2), rv=(-2, -1), **kwargs):
            return self.get_null('ang_definition', bend=b, front_vector=fv, rear_vector=rv, **kwargs)
...
# print(t1-t0)
# print(t2-t1)
# print(init_dict.get_null('env_conf'))
# print(get_default('larva_model'))
