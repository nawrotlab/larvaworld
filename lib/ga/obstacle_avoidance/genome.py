...
MOTOR_CTRL_COEFFICIENT_MIN = 0
MOTOR_CTRL_COEFFICIENT_MAX = 10000

MOTOR_CTRL_MIN_ACTUATOR_VALUE_MIN = 0
MOTOR_CTRL_MIN_ACTUATOR_VALUE_MAX = 400

SENSOR_DELTA_DIRECTION_MIN = 0
SENSOR_DELTA_DIRECTION_MAX = math.pi / 2

SENSOR_SATURATION_VALUE_MIN = 10
SENSOR_SATURATION_VALUE_MAX = 1000

SENSOR_MAX_DISTANCE_MIN = 10
