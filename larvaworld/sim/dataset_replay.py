...
from larvaworld import reg, aux, util
...
from larvaworld.process.spatial import fixate_larva
from larvaworld.screen import ScreenManager
...
def smaller_dataset(dataset=None,refID=None,dir=None, track_point=None, agent_ids=None, transposition=None,
    ...
    if transposition is not None:
        try:
            ...
            from larvaworld.process.spatial import align_trajectories
