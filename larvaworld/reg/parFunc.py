...
from larvaworld.aux import naming as nam
from larvaworld.reg import funcs
from larvaworld import aux

@funcs.param("track_par")
def track_par_func(chunk, par):
    def func(d):
        from larvaworld.process.annotation import track_par_in_chunk
...
def chunk_func(kc, store=False):
    if kc in ['str', 'pau', 'exec', 'str_c', 'run']:
        def func(d):
            from larvaworld.process.annotation import crawl_annotation
        ...
        def func(d):
            from larvaworld.process.annotation import turn_annotation
            s, e, c = d.step_data, d.endpoint_data, d.config
...
def dsp_func(range):
    ...
    def func(d):
        from larvaworld.process.spatial import comp_dispersion
        s, e, c = d.step_data, d.endpoint_data, d.config
...
def tor_func(dur):
    def func(d):
        from larvaworld.process.spatial import comp_straightness_index
        s, e, c = d.step_data, d.endpoint_data, d.config
