...
from larvaworld.aux import naming as nam, moving_average
...
def epoch_func(**kwargs):
    from larvaworld.process.annotation import detect_turns, detect_strides, detect_pauses, process_epochs
