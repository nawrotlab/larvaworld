...
from larvaworld.model.agents._larva import LarvaMotile
from larvaworld.model.modules.motor_controller import MotorController, Actuator
from larvaworld.model.modules.sensor2 import ProximitySensor
