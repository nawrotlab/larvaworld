...
from larvaworld.model.agents import LarvaworldAgent, LarvaBody, PhysicsController
...
class LarvaMotile(LarvaBody,Larva, PhysicsController):
    ...
    def build_energetics(self, energetic_pars, life_history):
        from larvaworld.model.deb.deb import DEB
    ...
    def build_brain(self, conf):
        if conf.nengo:
            ...
            from larvaworld.model.modules.brain import DefaultBrain
