...
from larvaworld import reg, aux, util, plot
from larvaworld.screen.drawing import ScreenManager
from larvaworld.model import envs, agents
from larvaworld.model.envs.conditions import get_exp_condition
from larvaworld.sim.run_template import BaseRun
...
class ExpRun(BaseRun):
    ...
    def get_larva_dicts(self, ids=None):
        ...
        for id, l in ls.items():
            ...
            try :
                from larvaworld.model.modules.nengobrain import NengoBrain
