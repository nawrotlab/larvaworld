...
from larvaworld.screen import SimulationScale

os.environ['PYGAME_HIDE_SUPPORT_PROMPT'] = "hide"
import pygame

from larvaworld import reg, aux, screen
...
class GA_ScreenManager(BaseScreenManager):
    ...
    def initialize(self):
        ...
        if v.show_display:
            from larvaworld.screen.side_panel import SidePanel
...
class ScreenManager(BaseScreenManager):
    ...
    def eval_keypress(self, k):
        from larvaworld.model.agents._larva_sim import LarvaSim
        from larvaworld.model.agents._larva import Larva
        # print(k)
        if k == '▲ trail duration':
