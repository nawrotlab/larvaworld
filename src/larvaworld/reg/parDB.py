...
from larvaworld.aux.par_aux import tilde, circle, bar, wave, subsup, sub, sup, th, Delta, dot, circledast, omega, ddot, mathring, delta
from larvaworld import reg, aux, util, decorators
...
def buildInitDict():
    ...
    def substrate():
        from larvaworld.model.deb.substrate import substrate_dict
        d = aux.AttrDict()
