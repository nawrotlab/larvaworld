...
from larvaworld.aux.par_aux import sub, subsup, circle, bar, tilde, sup
...
def init_brain_modules():
    from larvaworld.model import modules
    def Tur0():
...
class ModelRegistry:
    ...
    def mIDtable(self, mID,m=None, columns=['parameter', 'symbol', 'value', 'unit'],
        ...
        from larvaworld.plot.table import conf_table
        if m is None :
    ...
    def adapt_mID(self, refID, mID0, mID=None, space_mkeys=['turner', 'interference'], save_to=None, e=None, c=None,
        ...
        from larvaworld.sim.genetic_algorithm import optimize_mID
